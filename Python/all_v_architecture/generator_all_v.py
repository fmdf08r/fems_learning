    ...
    with open(data_path + "labels_set.csv", "wb") as l:
        for t in range(timesteps -1):
            ...
            for idx, row in df_next.iterrows():
                t_next[ int(row['v1']) ] = str(row['p1x']) + "," + str(row['p1y']) + "," + str(row['p1z']) + "," + str(row['v1x']) + "," + str(row['v1y']) + "," + str(row['v1z']) + "," + str(row['f1x']) + "," + str(row['f1y']) + "," + str(row['f1z'])
                t_next[ int(row['v2']) ] = str(row['p2x']) + "," + str(row['p2y']) + "," + str(row['p2z']) + "," + str(row['v2x']) + "," + str(row['v2y']) + "," + str(row['v2z']) + "," + str(row['f2x']) + "," + str(row['f2y']) + "," + str(row['f2z'])
                t_next[ int(row['v3']) ] = str(row['p3x']) + "," + str(row['p3y']) + "," + str(row['p3z']) + "," + str(row['v3x']) + "," + str(row['v3y']) + "," + str(row['v3z']) + "," + str(row['f3x']) + "," + str(row['f3y']) + "," + str(row['f3z'])
                t_next[ int(row['v4']) ] = str(row['p4x']) + "," + str(row['p4y']) + "," + str(row['p4z']) + "," + str(row['v4x']) + "," + str(row['v4y']) + "," + str(row['v4z']) + "," + str(row['f4x']) + "," + str(row['f4y']) + "," + str(row['f4z'])
