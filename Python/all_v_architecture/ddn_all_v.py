...
# train
hist = deep_NN.fit(xTrain, yTrain, batch_size=10, nb_epoch=100, validation_data=(xTest, yTest), verbose=1, shuffle=True)
y_pred = deep_NN.predict(xTrain, batch_size=10, verbose=1)

# saving history
sys.stdout.write('history: saving to file')
with open('../../training/all_v_results:(1hl,100u,100ep).csv', 'wb') as f:
